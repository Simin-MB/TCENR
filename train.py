...
INPUT_SIZE = 1711
WORDS = sys.argv[1]
PATH = "/content/drive/MyDrive/preprocessed/combined_model"+ str(INPUT_SIZE) + "k_" + WORDS + "/"
reviews_file="reviews"

# Loading the preprocessed data

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/train.pkl",'rb') as file:

  train = pickle.load(file)

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/test.pkl",'rb') as file:

  test = pickle.load(file)

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/validation.pkl",'rb') as file:

  validation = pickle.load(file)

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/reviews.pkl",'rb') as file:

  reviews = pickle.load(file)

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/user_graph.pkl",'rb') as file:

  user_graph = pickle.load(file)

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/poi_graph.pkl",'rb') as file:

  poi_graph = pickle.load(file)

with open("/content/drive/MyDrive/preprocessed/combined_model4k_3000/glove_file.pkl",'rb') as file:
...
# Train the model using fit generator. Each step is defined to be in batch size, and each epoch is evaluated using the validation set.

history = model.fit(generate_instances(BATCH_SIZE,train['user'],train['poi'],train['review'],embedded_user_reviews,
...
# Define the data structures for the test set - number of test instances, embedded contextual graphs and transformed written reviews
...
results = model.evaluate(generate_instances(BATCH_SIZE,test['user'],test['poi'],test['review'],
