...
FILE_NAME = "/content/drive/MyDrive/Yelp/yelp_academic_dataset_review.json"
USER_FILE = "/content/drive/MyDrive/Yelp/yelp_academic_dataset_user.json"
POI_FILE = "/content/drive/MyDrive/Yelp/yelp_academic_dataset_business.json"
# Glove file location used for the words embedding layer
GLOVE_FILE = "/content/drive/MyDrive/Yelp/glove.6B."
# Glove file size
...
WORK_DIR = "/content/drive/MyDrive/preprocessed/combined_model" + str(int(len(new_data)/1000)) + "k_" + str(user_words_perc) + "/"
